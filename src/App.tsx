...
// 🌟 NAYA: Yahan aap apna khufiya PIN code set kar sakte hain (Abhi 1234 hai)
...
export default function App() {
  ...
  // 🌟 NAYA: Admin button dabane par PIN check karne ka function
  const handleAdminToggle = () => {
    if (!isModeAdmin) {
      ...
      setIsModeAdmin(false); // Wapas POS par jane ke liye password nahi chahiye
    }
  };

  // Parchi ka text banane ka function
